...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        ...
        print(f"No! The {question_type} of {die_1_value} and {die_2_value} is {correct_answer}!")
    else:
        correct_answer = abs(die_1_value - die_2_value)
        print(f"No! The {question_type} between {die_1_value} and {die_2_value} is {correct_answer}!")
